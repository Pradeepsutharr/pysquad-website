...
function PrivacyPolicy() {
  return (
    <>
      <SEO
        pageTitle={"Privacy Policy | Pysquad"}
        pageDescription={
          "Learn how Pysquad safeguards your personal information, website usage data, and business information. Read our privacy practices, GDPR compliance, and user data protection measures."
        }
        keywords={
          "Pysquad privacy policy, data protection, GDPR, user privacy, personal information, website privacy, data security, privacy practices"
        }
        ogTitle={"Privacy Policy | Pysquad"}
        ogUrl={"https://pysquad.com/privacy-policy"}
      />

      <section className="py-12 md:py-16">
        <div className="container">
          <div className="space-y-10 leading-loose text-textSecondary">
            <div className="space-y-3">
              <h1 className="text-4xl font-bold text-textPrimary">
                PRIVACY POLICY
              </h1>
              <p>
                This privacy notice for PySquad Informatics LLP (“Company”,
              ...
              <ul className="list-disc ps-10">
                <li>
                  Visit our website at http://www.pysquad.com, or any website of
              ...
              <p>
                ...
                at contact@pysquad.com.
              </p>
            </div>

            {/* Summary of key points */}
            <div className="space-y-3">
              <h2 className="text-2xl font-bold text-textPrimary mt-4 mb-2">
                SUMMARY OF KEY POINTS
              </h2>
              <p>
              ...
              <ul className="space-y-3">
                <li>
                  ...
                  depending on how you interact with PySquad Informatics LLP and
                ...
                <li>
                  Want to learn more about what PySquad Informatics LLP does
                  with any information we collect? Review the privacy notice in
                  full.
                </li>
              </ul>
            </div>
            ...
            {/* Strict Usage Policy */}
            <div className="space-y-3">
              <h2 className="text-2xl font-bold text-textPrimary mt-6 mb-2">
                Strict Usage Policy for our Products
              </h2>
              <p>
                The use of any software product developed by PySquad, whether
                knowingly or unknowingly for any showcase or presentation, is
                strictly prohibited without explicit written or email approval
                from PySquad. Unauthorized use, reproduction, or distribution of
                our products will result in immediate legal action. All parties
                must obtain formal permissions through our official
                communication channels prior to any usage. Failure to comply
                with these requirements constitutes a violation of our
                intellectual property rights and will be prosecuted to the
            ...
            {/* Table of Contents */}
            <div className="space-y-3">
              <h2 className="text-2xl font-bold text-textPrimary mt-10 mb-2">
                TABLE OF CONTENTS
              </h2>
              <ul className="list-decimal ps-10 space-y-3">
                <li className="mb-1">WHAT INFORMATION DO WE COLLECT?</li>
                <li className="mb-1">HOW DO WE PROCESS YOUR INFORMATION?</li>
                <li className="mb-1">
                ...
                <li className="mb-1">HOW LONG DO WE KEEP YOUR INFORMATION?</li>
                <li className="mb-1">HOW DO WE KEEP YOUR INFORMATION SAFE?</li>
                <li className="mb-1">DO WE COLLECT INFORMATION FROM MINORS?</li>
                <li className="mb-1">WHAT ARE YOUR PRIVACY RIGHTS?</li>
                <li className="mb-1">CONTROLS FOR DO-NOT-TRACK FEATURES</li>
                <li className="mb-1">
                  DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?
                </li>
                <li className="mb-1">DO WE MAKE UPDATES TO THIS NOTICE?</li>
                <li className="mb-1">
            ...
            <div className="space-y-3">
              ...
              <p>
                ...
                information that you voluntarily provide to us when you express
              ...
              <p>
                Sensitive Information. We do not process sensitive personal
                information.
              </p>
              <p>
              ...
              <h4 className="font-semibold text-xl text-textPrimary mt-4">
            ...
            {/* Section 3 and onwards (follow same pattern for all) */}
            <div className="space-y-3">
              <h3 className="text-2xl font-bold text-textPrimary mt-8 mb-2">
              ...
              <p>
                <span className="font-medium">In Short:</span> We only process
                ...
                provide you with services to enter into or fulfil our
                contractual obligations, to protect your rights, or to fulfil
            ...
            {/* Repeat for sections 5-14 as parsed */}
            ...
            <div className="space-y-3">
              ...
              <p>
                <span className="font-medium">In Short:</span> In some regions,
                such as the European Economic Area (EEA), United Kingdom (UK),
                and Canada, you have rights that allow you greater access to and
              ...
              <p>
                ...
                also opt out of interest-based advertising by advertisers on our
                Services.
              </p>
              <p>
                If you have questions or comments about your privacy rights, you
                may email us at contact@pysquad.com.
              </p>
            </div>
            ...
            <div className="space-y-3">
              ...
              <p>
                ...
                email us at contact@pysquad.com or contact us by post at:
              </p>
              <ul className="list-disc pl-5">
                <li>PySquad Informatics LLP</li>
                <li>A 605, Shilp Aaron</li>
                <li>Sindhubhavan Road</li>
                <li>Ahmedabad, Gujarat 380054</li>
                <li>India</li>
              </ul>
            </div>
